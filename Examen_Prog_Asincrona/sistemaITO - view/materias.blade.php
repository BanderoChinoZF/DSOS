    ...
    <div class="container">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {!! Form::select('sexo', ['M' => 'Masculino', 'F' => 'Femenino'], null, ['id'=>'sexo','placeholder' => 'Seleccione un genero ...']) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {!! Form::select('hombres',[],null, ['id'=>'hombre','placeholder' => 'Seleccione un alumno ...']) !!}
                </div>
            </div>
